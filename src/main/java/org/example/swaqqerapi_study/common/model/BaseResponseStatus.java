package org.example.swaqqerapi_study.common.model;
...
public enum BaseResponseStatus {
    ...
    SINGUP_DUPLICATE_EMAIL(false, 3003, "중복된 이메일입니다."),
    ...
    LOGUN_INVALID_USERINFO(false, 3006, "아이디나 비밀번호를 확인해주세요"),

    // 4000번대
    REQUEST_ERROR(false, 4001, "입력 값이 잘못되었습니다."),
